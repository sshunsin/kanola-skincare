...
<div class="app-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            ...
            <h2><i class="fa-solid fa-clock"></i> Tambah Kehadiran</h2>
        </div>

        <div class="card">
            <form method="POST" action="{{ route('backend.v1.attendances.store') }}">
            @csrf
                ...
                <input type="text" name="name" placeholder="Ketik nama karyawan..." required>
