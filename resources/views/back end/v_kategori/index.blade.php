@extends('back end.v_layouts.app') 
@section('content') 
<!-- contentAwal --> 
...
<div class="row"> 
    ...
    <div class="col-12"> 
        <a href="{{ route('backend.v1.categories.create') }}"> 
                    ...
                    <table id="zero_config" class="table table-striped table-bordered"> 
                        ...
                        <tbody> 
                            ...
                            <tr> 
                                ...
                                <td> 
                                    <a href="{{ route('backend.v1.categories.edit', $row->id) }}" title="Ubah Data"> 
                                        <button type="button" class="btn btn-cyan btnsm"><i class="far fa-edit"></i> Ubah</button> 
                                    </a> 
 
                                    <form method="POST" action="{{ route('backend.v1.categories.destroy', $row->id) }}" style="display: inline-block;"> 
                                        @method('delete') 
                                        @csrf 
