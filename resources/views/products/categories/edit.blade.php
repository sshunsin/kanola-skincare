...
<div class="main-content">
    <h2 class="main-title">Edit Kategori Produk ✏️</h2>
    ...
    <div class="card">
        <form action="{{ route('backend.v1.categories.update', $category->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="input-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="name" value="{{ $category->category_name }}" list="category_options" placeholder="Pilih atau ketik perubahan kategori..." required autocomplete="off">
