...
<div class="main-content">
    <h2 class="main-title">Tambah Products Complain</h2>
    <a class="btn btn-back" href="{{ route('backend.v1.projects.evaluation.index') }}"><i class="fa-solid fa-arrow-left"></i> Kembali</a>

    <div class="form-card">
        <form method="POST" action="{{ route('backend.v1.projects.evaluation.store') }}">
            @csrf

            <div class="full-width">
                <label><i class="fa-solid fa-key"></i> Kode Products Complain</label>
                <input type="text" name="code" placeholder="PE-6-CL-KNL-001">
            </div>
            ...
            <div class="full-width">
                ...
                <textarea name="manager_notes"></textarea>
            </div>

            <div class="full-width">
                <button type="submit" class="submit-btn"><i class="fa-solid fa-floppy-disk"></i> Simpan Complain</button>
            </div>
