...
<html>
<head>
    <title>Tambah Timeline Proyek</title>
...
<div class="main-content">
    <h2 class="main-title">Tambah Batch Product</h2>

    <a class="btn btn-back" href="{{ route('backend.v1.projects.timeline.index') }}">
        <i class="fa-solid fa-arrow-left"></i> Kembali ke Batch
    </a>

    <br><br>

    <div class="form-card">
        <form method="POST" action="{{ route('backend.v1.projects.timeline.store') }}">
            @csrf

            <label>Kode Batch</label>
            <input type="text" name="code" placeholder="BP-1-FW-KNL-001" required>

            <label>Judul Tahap</label>
            <input type="text" name="title" placeholder="Perencanaan Awal" required>
            ...
            <button type="submit">
                <i class="fa-solid fa-save"></i> Simpan Batch
            </button>
        </form>
    </div>
</div>
